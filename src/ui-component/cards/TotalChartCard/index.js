                ...
                <Grid container direction="column">
                    <Grid item>
                        <Grid container alignItems="center">
                            <Grid item>
                                <Typography className={classes.cardHeading}>{props.total_today_assign_task}</Typography>
                            </Grid>
                            <Grid item>
                                <Avatar className={classes.avatarCricle} onClick={(e) => Assign(e)}>
                    ...
                    <Grid item>
                        <Typography className={classes.subHeading}>Assign Task</Typography>
                    </Grid>
                </Grid>
            </CardContent>
        </Card>
